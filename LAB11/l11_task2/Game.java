...
public class Game {
    ...
    private void initializePanel(){
        ...
        GuessPanel guessPanel = new GuessPanel(mediator);
        panel.add(guessPanel, gbcPanel);
        gbcPanel.gridx=2;
        gbcPanel.gridy=2;
        gbcPanel.gridwidth=2;
        gbcPanel.gridheight=2;

        AnswerPanel answerPanel = new AnswerPanel(mediator);
        panel.add(answerPanel, gbcPanel);

        mediator.register(guessPanel);
        mediator.register(answerPanel);
    }
